...
<div class="d-flex justify-content-between align-items-end">
    <h1 class="title">Tms Course Information</h1>
    <a href="{{ route('tms-course.create') }}" class="btn btn-primary">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table  table-bordered">
                ...
                <tbody>
                    @foreach ($tmsCourses as $tmsCourse)
                    <tr>
                        <td>{{ $loop->iteration}}</td>

                        <td>{{ $tmsCourse->name_bn }}</td>
                        <td>{{ $tmsCourse->name_en }}</td>

                        <td>
                            <form action="{{ route('tms-course.destroy',$tmsCourse->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('tms-course.show',$tmsCourse->id) }}">
                                                <span class="material-icons-outlined">
                                                    visibility
                                                </span>
                                                View
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('tms-course.edit',$tmsCourse->id) }}">
                                                <span class="material-icons-outlined">
                                                    edit
                                                </span>
                                                Edit
