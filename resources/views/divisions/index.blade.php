            ...
            <form id="division_add_form" method="post" class="form m-7" action="">
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::First Name-->
                        <input type="text" placeholder="{{ __('division-list.division_name_ph') }}" type="text"
                            id="division" name="name" autocomplete="off"
            ...
            <form id="division_edit_form" method="post" class="form m-7" action="">
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--begin::First Name-->
                        <input type="text" placeholder="{{ __('division-list.division_name') }}" type="text" id="name"
