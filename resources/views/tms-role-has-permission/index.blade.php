...
<div class="d-flex justify-content-between align-items-end">
    <h1 class="title">Tms Role Has Permission Information</h1>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table  table-bordered">
                ...
                <tbody>
                    @foreach ($tmsRoleHasPermissions as $tmsRoleHasPermission)
                    <tr>
                        <td>{{ $loop->iteration}}</td>

                        <td>{{ $tmsRoleHasPermission->permission_id }}</td>
                        <td>{{ $tmsRoleHasPermission->role_id }}</td>

                        <td>
                            <form action="{{ route('permission.destroy',$tmsRoleHasPermission->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('permission.show',$tmsRoleHasPermission->id) }}">
                                                <span class="material-icons-outlined">
                                                    visibility
                                                </span>
                                                View
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('permission.edit',$tmsRoleHasPermission->id) }}">
                                                <span class="material-icons-outlined">
                                                    edit
                                                </span>
                                                Edit
