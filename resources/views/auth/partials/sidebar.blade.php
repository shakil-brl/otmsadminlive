        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <!--begin:Menu link-->
                    <span
                        class="menu-link sidebar-menu-link <?php if (Route::is('divisions.index') || Route::is('divisions.show')|| Route::is('districts.index') || Route::is('districts.show')|| Route::is('upazilas.index') || Route::is('upazilas.show') || Route::is('providers.index') || Route::is('providers.show')|| Route::is('provider.link-batch')) {?>active<?php } ?>">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <!--begin:Menu link-->
                    <span
                        class="menu-link sidebar-menu-link <?php if (Route::is('traineeEnroll.index')||Route::is('trainerEnroll.index')||Route::is('batches.index')) {?>active<?php } ?>">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <!--begin:Menu link-->
                    <span
                        class="menu-link sidebar-menu-link <?php if (Route::is('dashboard_details.total_batches')||Route::is('batch-schedule.office')||Route::is('attendance.schedule')) {?>active<?php } ?>">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <!--begin:Menu link-->
                    <span
                        class="menu-link sidebar-menu-link <?php if (Route::is('batch-schedule.runningBatches')) {?>active<?php } ?>">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <!--begin:Menu link-->
                    <span
                        class="menu-link sidebar-menu-link <?php if (Route::is('batch-schedule.running-class-list')||Route::is('tms-inspections.create')) {?>active<?php } ?>">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <!--begin:Menu link-->
                    <span
                        class="menu-link sidebar-menu-link <?php if (Route::is('inspaction.index')||Route::is('tms-inspections.show')) {?>active<?php } ?>">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <!--begin:Menu link-->
                    <span
                        class="menu-link sidebar-menu-link <?php if (Route::is('products.index')||Route::is('products.create')||Route::is('products.edit')||Route::is('product-combos.index')||Route::is('product-combos.create')||Route::is('product-combos.edit')) {?>active<?php } ?>">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <!--begin:Menu link-->
                    <span
                        class="menu-link sidebar-menu-link <?php if (Route::is('evaluation-head.index')||Route::is('evaluation-head.create')||Route::is('evaluation-head.edit')||Route::is('trainer-schedule-details.lists')||Route::is('trainer-schedule-details.students')||Route::is('trainer-schedule-details.show-student-evaluation')) {?>active<?php } ?>">
                        <span class="menu-icon">
