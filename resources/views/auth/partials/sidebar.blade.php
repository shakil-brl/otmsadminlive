                                ...
                                @empty(!$roleRoutePermissions)
                                    ...
                                    @if (
                                        ...
                                        <div data-kt-menu-trigger="click"
                                            ...
                                            <!--begin:Menu link-->
                                            <span class="menu-link sidebar-menu-link <?php if (Illuminate\Support\Facades\Route::is('batches.all')||Illuminate\Support\Facades\Route::is('batch-schedule.office')||Illuminate\Support\Facades\Route::is('attendance.schedule')) {?>active<?php } ?>">
                                                <span class="menu-icon">
                                        ...
                                        <div data-kt-menu-trigger="click"
                                            class="menu-item here menu-accordion  <?php if (Illuminate\Support\Facades\Route::is('inspaction.index')||Illuminate\Support\Facades\Route::is('tms-inspections.show')||Illuminate\Support\Facades\Route::is('report.feedback.trainee')||Illuminate\Support\Facades\Route::is('report.feedback.trainer')) {?>here show<?php } ?>">
                                            <!--begin:Menu link-->
                                            <span class="menu-link sidebar-menu-link <?php if (Illuminate\Support\Facades\Route::is('inspaction.index')||Illuminate\Support\Facades\Route::is('tms-inspections.show')||Illuminate\Support\Facades\Route::is('report.feedback.trainee')||Illuminate\Support\Facades\Route::is('report.feedback.trainer')) {?>active<?php } ?>">
                                                <span class="menu-icon">
                                            ...
                                            <div class="menu-sub menu-sub-accordion" kt-hidden-height="124" style="">
                                                <!--begin:Menu sub-->
                                                <div class="menu-sub menu-sub-accordion <?php if (Illuminate\Support\Facades\Route::is('inspaction.index')||Illuminate\Support\Facades\Route::is('tms-inspections.show')||Illuminate\Support\Facades\Route::is('report.feedback.trainee')||Illuminate\Support\Facades\Route::is('report.feedback.trainer')) {?>here show<?php } ?>"
                                                    kt-hidden-height="81" style="">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link show-loader  sidebar-menu-link <?php if (Illuminate\Support\Facades\Route::is('report.feedback.trainee')) {?>active<?php } ?>"
                                                            href="{{ route('report.feedback.trainee') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>


                                                            </span>
                                                            <span class="menu-title">{{ __('sidemenu.trainee_feedback_report') }}</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                                                    <!--end:Menu item-->
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link show-loader  sidebar-menu-link <?php if (Illuminate\Support\Facades\Route::is('report.feedback.trainer')) {?>active<?php } ?>"
                                                            href="{{ route('report.feedback.trainer') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>


                                                            </span>
                                                            <span class="menu-title">{{ __('sidemenu.trainer_feedback_report') }}</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                                                    <!--end:Menu item-->
