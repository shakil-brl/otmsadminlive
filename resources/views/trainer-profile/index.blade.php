...
<div class="d-flex justify-content-between align-items-end">
    <h1 class="title">Trainer Profile Information</h1>
    <a href="{{ route('trainer-profile.create') }}" class="btn btn-primary">
            ...
            <table class="table  table-bordered">
                <thead class="thead">
                    <tr>
                        ...
                        <th>Profileid</th>
                        <th>Professionalbio</th>
                        <th>Review</th>
                        <th>Rating</th>
                        <th>Isactive</th>
                        <th>Creatorprofileid</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $trainerProfile->ProfileId }}</td>
                        <td>{{ $trainerProfile->professionalBio }}</td>
                        <td>{{ $trainerProfile->review }}</td>
                        <td>{{ $trainerProfile->rating }}</td>
                        <td>{{ $trainerProfile->isActive }}</td>
                        <td>{{ $trainerProfile->CreatorProfileId }}</td>

                        <td>
                            <form action="{{ route('trainer-profile.destroy',$trainerProfile->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('trainer-profile.show',$trainerProfile->id) }}">
                                                <span class="material-icons-outlined">
                                                    visibility
                                                </span>
                                                View
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('trainer-profile.edit',$trainerProfile->id) }}">
                                                <span class="material-icons-outlined">
                                                    edit
                                                </span>
                                                Edit
