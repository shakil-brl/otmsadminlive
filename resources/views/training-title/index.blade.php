...
<div class="d-flex justify-content-between align-items-end">
    <h1 class="title">Training Title Information</h1>
    <a href="{{ route('training-title.create') }}" class="btn btn-primary">
            ...
            <table class="table  table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $trainingTitle->NameEn }}</td>
                        <td>{{ $trainingTitle->TrainingAreaId }}</td>

                        <td>
                            <form action="{{ route('training-title.destroy',$trainingTitle->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('training-title.show',$trainingTitle->id) }}">
                                                <span class="material-icons-outlined">
                                                    visibility
                                                </span>
                                                View
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('training-title.edit',$trainingTitle->id) }}">
                                                <span class="material-icons-outlined">
                                                    edit
                                                </span>
                                                Edit
