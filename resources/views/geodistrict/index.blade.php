...
<div class="d-flex justify-content-between align-items-end">
    <h1 class="title">Geodistrict Information</h1>
    <a href="{{ route('geodistrict.create') }}" class="btn btn-primary">
            ...
            <table class="table  table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $geodistrict->Code }}</td>
                        <td>{{ $geodistrict->Name }}</td>
                        <td>{{ $geodistrict->NameEng }}</td>
                        <td>{{ $geodistrict->ParentCode }}</td>

                        <td>
                            <form action="{{ route('geodistrict.destroy',$geodistrict->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('geodistrict.show',$geodistrict->id) }}">
                                                <span class="material-icons-outlined">
                                                    visibility
                                                </span>
                                                View
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('geodistrict.edit',$geodistrict->id) }}">
                                                <span class="material-icons-outlined">
                                                    edit
                                                </span>
                                                Edit
