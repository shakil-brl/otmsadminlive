                    ...
                    <div class="row g-4 row-cols-3 cards" id="dashboard-card">
                        @if (in_array($userRole, [
                            ...
                            <div>
                                ...
                                <x-dashboard-card :url="route('dashboard_details.total_batches')" :totalBatch="$data['totalBatch'] ?? 0" :icon="asset('img/new_icon/total_batch.png')" :title="__('dashboard.total_batch')"
                        ...
                        @if (in_array($userRole, [
                            ...
                            <div>
                                <x-dashboard-card :url="route('dashboard_details.running_batches')" :totalBatch="$data['runningBatch'] ?? 0" :icon="asset('img/new_icon/current_batch.png')" :title="__('dashboard.running_batch')"
                        ...
                        @if (in_array($userRole, [
                            ...
                            <div>
                                <x-dashboard-card :url="route('dashboard_details.complete_batches')" :totalBatch="$data['completeBatch'] ?? 0" :icon="asset('img/new_icon/completed_batch.png')"
                        ...
                        @if (in_array($userRole, ['SuperAdmin', 'superAdmin', 'Admin', 'admin', 'DPD', 'dpd', 'DG', 'dg']))
                            <div>
                                <x-dashboard-card :url="route('dashboard_details.districts')" :totalBatch="$data['totalDistrict'] ?? 0" :icon="asset('img/new_icon/district.png')"
                        ...
                        @if (in_array($userRole, ['SuperAdmin', 'superAdmin', 'Admin', 'admin', 'DPD', 'dpd', 'DG', 'dg']))
                            <div>
                                <x-dashboard-card :url="route('dashboard_details.upazilas')" :totalBatch="$data['totalUpazila'] ?? 0" :icon="asset('img/new_icon/upazila.png')"
                        ...
                        @if (in_array($userRole, ['SuperAdmin', 'superAdmin', 'Admin', 'admin', 'DPD', 'dpd', 'DG', 'dg']))
                            <div>
                                <x-dashboard-card :url="route('dashboard_details.partners')" :totalBatch="$data['totalProvider'] ?? 0" :icon="asset('img/new_icon/partner.png')"
                                        ...
                                        <div>
                                            <div class="content">
                                                ...
                                                <div class="attendance">
                                                    <div class="items">
                                                        <div class="item">
                                                            <div class="digit">{{ $data['totalPresentToday'] ?? 0 }}</div>
                                                    ...
                                                    <div class="items">
                                                        <div class="item">
                                                            <div class="digit">{{ $data['totalStudent'] }}</div>
                                                ...
                                                <div>
                                                    <div class="content">
                                                        ...
                                                        <div class="attendance">
                                                            <div class="items">
                                                                <div class="item">
                                                                    <div class="digit">{{ $data['totalTrainer'] ?? 0 }}
                                                                    </div>
                                                ...
                                                <div>
                                                    <div class="content">
                                                        ...
                                                        <div class="attendance">
                                                            <div class="items">
                                                                <div class="item">
                                                                    <div class="digit">{{ $data['totalStudent'] ?? 0 }}
                                                                    </div>
                                                                    <div class="label">
