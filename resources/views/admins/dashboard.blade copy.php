                ...
                <div class="row g-4 row-cols-3 cards" id="dashboard-card">
                    ...
                    <div>
                        ...
                        <x-dashboard-card :url="route('dashboard_details.total_batches')"
                            ...
                            :title="__('dashboard.total_batch')" :class="'card-item purple show-loader'" />
                    </div>
                    @endif
                    ...
                    <div>
                        <x-dashboard-card :url="route('dashboard_details.running_batches')"
                            ...
                            :title="__('dashboard.running_batch')" :class="'card-item yellow show-loader'" />
                    </div>
                    @endif
                    ...
                    <div>
                        <x-dashboard-card :url="route('dashboard_details.ongoing_classes', ['status' => 3])"
                    ...
                    @if (in_array('dashboard_details.partners', $roleRoutePermissions))
                    <div>
                        <x-dashboard-card :url="route('dashboard_details.partners')" :totalBatch="$total_ongoing ?? 0"
                            :icon="asset('img/new_icon/developmentpartner.png')" :title="__('dashboard.todays_class')"
                                            ...
                                            <div class="items">
                                                ...
                                                <div class="item">
                                                    <div class="digit">
                                                        ...
                                                        digitLocale($data['total_trainee']) : digitLocale(0) }}
                                                    </div>
                                                ...
                                                <div class="item">
                                                    <div class="digit">
                                                        ...
                                                        digitLocale($data['total_dropout']) : digitLocale(0) }}
                                                    </div>
                                                    ...
                                                    <div class="items">
                                                        <div class="item">
                                                            <div class="digit">
                                                                ...
                                                                digitLocale($data['total_trainer']) : digitLocale(0) }}
                                                            </div>
                                                            <div class="label">
