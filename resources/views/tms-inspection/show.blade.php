                        ...
                        <table class="table table-responsive align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <tbody class="text-gray-600 fw-semibold" id="user-tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-inspection-result :value="$tmsInspection->lab_attendance" :design="1" :lang="1" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>11.</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-inspection-result :value="$tmsInspection->student_laptop" :design="1" :lang="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-inspection-result :value="$tmsInspection->class_regularity" :design="1" :lang="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-inspection-result :value="$tmsInspection->trainer_attituted" :design="1" :lang="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-inspection-result :value="$tmsInspection->trainer_tab_attendance" :design="1" :lang="1" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>20.</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-inspection-result :value="$tmsInspection->upazila_monitoring" :design="1" :lang="1" />
