...
<div class="d-flex justify-content-between align-items-end">
    <h1 class="title">Tms Category Information</h1>
    <a href="{{ route('tms-categorie.create') }}" class="btn btn-primary">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table  table-bordered">
                ...
                <tbody>
                    @foreach ($tmsCategories as $tmsCategory)
                    <tr>
                        <td>{{ $loop->iteration}}</td>

                        <td>{{ $tmsCategory->name }}</td>

                        <td>
                            <form action="{{ route('tms-categorie.destroy',$tmsCategory->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('tms-categorie.show',$tmsCategory->id) }}">
                                                <span class="material-icons-outlined">
                                                    visibility
                                                </span>
                                                View
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('tms-categorie.edit',$tmsCategory->id) }}">
                                                <span class="material-icons-outlined">
                                                    edit
                                                </span>
                                                Edit
