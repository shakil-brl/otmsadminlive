                        ...
                        <div id="kt_user_report_views_export_menu"
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3"
                                    data-kt-user-export="copy">{{__('upazila-list.copy_clipboard')}}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3"
                                    data-kt-user-export="excel">{{__('upazila-list.export_excel')}}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3"
                                    data-kt-user-export="csv">{{__('upazila-list.export_csv')}}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3"
                                    data-kt-user-export="pdf">{{__('upazila-list.export_pdf')}}</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
            ...
            <form id="upazila_add_form" method="post" class="form m-7" action="">
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <select name="district_id" aria-label="Select District" data-control="select2"
                            data-placeholder="Select District" class="form-select form-select-solid "
            ...
            <form id="upazila_edit_form" method="post" class="form m-7" action="">
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <!--begin::Input-->
                        <select name="district_id" aria-label="Select District" data-control="select2"
                            data-placeholder="{{__('upazila-list.select_district')}}"
                            class="form-select form-select-solid " data-dropdown-parent="#upazila_edit_form"
                            id="district_id">
                        </select>
                        <span class="text-danger form-message-error-district_id"></span>
                        <!--end::Input-->
