            ...
            <form id="provider_edit_form" method="post" class="form m-7" action="">
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--begin::First Name-->
                        <input type="text" placeholder="{{ __('provider-list.provider_name_ph') }}" id="name"
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Email-->
                        <input type="text" placeholder="{{ __('provider-list.email_ph') }}" id="email" name="email"
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Mobile-->
                        <input type="text" placeholder="{{ __('provider-list.mobile_number_ph') }}" id="phone"
