...
<div class="d-flex justify-content-between align-items-end">
    <h1 class="title">Geodivision Information</h1>
    <a href="{{ route('geodivision.create') }}" class="btn btn-primary">
            ...
            <table class="table  table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $geodivision->NameEng }}</td>

                        <td>
                            <form action="{{ route('geodivision.destroy',$geodivision->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('geodivision.show',$geodivision->id) }}">
                                                <span class="material-icons-outlined">
                                                    visibility
                                                </span>
                                                View
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('geodivision.edit',$geodivision->id) }}">
                                                <span class="material-icons-outlined">
                                                    edit
                                                </span>
                                                Edit
